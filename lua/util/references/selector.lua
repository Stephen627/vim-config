...
M.select = function(config, items, encoding)
	...
	map("<CR>", require('util.references.selector').choose)
	map("<C-c>", require('util.references.selector').cancel)
	map("q", require('util.references.selector').cancel)
	map("<Esc>", require('util.references.selector').cancel)
	map("p", require('util.references.selector').preview)
